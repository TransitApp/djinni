...
fn generate_enum(
    ...
    let id_enum = &spec.cpp_ident_style.enum_;
    let id_method = &spec.cpp_ident_style.method;
    create_file_from_parts(spec.skip_generation, out_files, written_files, hpp_folder, &hpp_name, |w| {
...
fn generate_record(
    ...
    create_file_from_parts(spec.skip_generation, out_files, written_files, cpp_folder, &cpp_name_file, |w| {
        w.wl("// AUTOGENERATED FILE - DO NOT MODIFY!");
        w.wl(&format!("// This file was generated by Djinni from {}", origin));
        w.wl_empty();
