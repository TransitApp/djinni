...
fn generate_enum(
    ...
    create_file_from_parts(spec.skip_generation, out_files, written_files, folder, &hpp_name, |w| {
    ...
    if !wasm_omit_constants {
        ...
        create_file_from_parts(spec.skip_generation, out_files, written_files, folder, &cpp_name, |w| {
            w.wl("// AUTOGENERATED FILE - DO NOT MODIFY!");
            w.wl(&format!("// This file was generated by Djinni from {}", origin));
            w.wl_empty();
            ...
            wrap_namespace(w, &helper_ns, |w| {
                ...
                w.braced(|w| {
                    ...
                    w.nested(|w| {
                        ...
                        w.braced(|w| {
                            write_enum_option_none(w, &e_clone, id_js.enum_, ":");
                            write_enum_options(w, &e_clone, id_js.enum_, ":");
                            write_enum_option_all(w, &e_clone, id_js.enum_, ":");
                        });
                    });
                    w.wl("})");
                });
